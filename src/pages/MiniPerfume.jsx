...
function MiniPerfume({ addToWishlist, addToCart }) {
  ...
  useEffect(() => {
    ...
    let url = `${baseURL}/api/products?category=mini-perfume`;
  ...
  const heroSubtitles = [
    "Luxury scents in travel-friendly sizes",
    "Carry your signature fragrance anywhere",
    "Small bottles, powerful impressions",
    "Elegance in every drop",
    "Perfect for on-the-go sophistication"
  ];
  ...
  return (
    <div className="bg-softwhite min-h-screen">
      ...
      <SectionVideo
        src="/videos/miniperfume.mp4"
        title="Mini Perfume"
        subtitle="Luxury fragrance in its most portable form."
      />
    </div>
  );
}

export default MiniPerfume;