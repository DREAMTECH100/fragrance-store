...
function BodyMist({ addToWishlist, addToCart }) {
  ...
  useEffect(() => {
    ...
    let url = `${baseURL}/api/products?category=body-mist`;
  ...
  const heroSubtitles = [
    "Light, refreshing scents for everyday luxury",
    "Effortless fragrance that lingers softly",
    "Fresh notes designed to uplift your mood",
    "Subtle, clean, and captivating aromas",
    "Your everyday signature scent"
  ];
  ...
  return (
    <div className="bg-softwhite min-h-screen">
      ...
      <SectionVideo
        src="/videos/bodymist.mp4"
        title="Body Mist"
        subtitle="Light, refreshing fragrance for every moment."
      />
    </div>
  );
}
