...
function Gifts({ addToWishlist, addToCart }) {
  ...
  const heroSubtitles = [
    ...
    "Gifts designed to impress",
    "Luxury wrapped in intention",
    "Perfect expressions of elegance",
    "Thoughtful luxury, beautifully presented"
  ];
